...
import activeStyle from '../../assets/ActiveStyle.png'
import controlDeCuotas from '../../assets/ControlDeCuotas.png'
const Proyectos = () => {
  return (
    <div className='container-proyecto'>
        ...
        <div className='section-cards-proyecto'>
            <div className='cards-proyecto'>
                <img src={controlDeCuotas} alt="Proyecto Control de Cuotas" />
            ...
            <div className='cards-proyecto'>
            <img src={activeStyle} alt="Proyecto e-commerce" />
                <h4>ActiveStyle</h4>
